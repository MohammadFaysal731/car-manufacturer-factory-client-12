...
const ContactMe = () => {
    ...
    return (
        <div className=''>
            ...
            <div class="hero min-h-screen hero-overlay bg-opacity-60">
                    ...
                    <div className="flex justify-center items-center m-5">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="grid grid-cols-1 gap-5 border-2 p-9">
                                ...
                                <input  {...register("subject", { required: true })} type="text" placeholder="Your Subject" class="input input-bordered input-accent w-full max-w-xs" />
